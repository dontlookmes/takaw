...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT saveproduct.*
            FROM saveproduct
            INNER JOIN users ON saveproduct.add_by = users.email
    ...
    $sql = "SELECT * FROM cart WHERE product_id = ? AND add_by = ?";
